...
// Function to get user details by product ID
export const getUserDetailsByProductId = (productId) => {
    return db.prepare('SELECT email, target_price FROM user_notifications WHERE product_id = ?').get(productId);
};
